...
RESOURCES += src/qt/ans.qrc src/qt/ans_locale.qrc

TRANSLATIONS += src/qt/locale/ans_bg.ts \
                src/qt/locale/ans_de.ts \
                src/qt/locale/ans_en.ts \
                src/qt/locale/ans_es.ts \
                src/qt/locale/ans_fi.ts \
                src/qt/locale/ans_fr.ts \
                src/qt/locale/ans_it.ts \
                src/qt/locale/ans_ja.ts \
                src/qt/locale/ans_pl.ts \
                src/qt/locale/ans_pt.ts \
                src/qt/locale/ans_ru.ts \
                src/qt/locale/ans_sk.ts \
                src/qt/locale/ans_sv.ts \
                src/qt/locale/ans_vi.ts \
                src/qt/locale/ans_zh_CN.ts \
                src/qt/locale/ans_zh_TW.ts
