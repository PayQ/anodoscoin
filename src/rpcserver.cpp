...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ANS features */
        {"ans", "masternode", &masternode, true, true, false},
        {"ans", "masternodelist", &masternodelist, true, true, false},
        {"ans", "mnbudget", &mnbudget, true, true, false},
        {"ans", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"ans", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ans", "mnsync", &mnsync, true, true, false},
        {"ans", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use ansd, or the -server option to ans-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> ans-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:30102/\n";
}
