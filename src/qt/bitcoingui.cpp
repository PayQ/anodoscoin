                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Anodos-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ANS address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ans: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About ANS Core"), this);
    aboutAction->setStatusTip(tr("Show information about ANS Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ANS"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ANS addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ANS addresses"));
    ...
    openAction->setStatusTip(tr("Open a ANS: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the ANS Core help message to get a list with possible ANS command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("ANS Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ANS network", "", count));
}
...
{
    QString strTitle = tr("ANS Core"); // default title
