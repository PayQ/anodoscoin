...
#if defined(NDEBUG)
#error "ANS cannot be compiled without assertions."
#endif
...
unsigned int nStakeMinAge = 0.75 * 60 * 60;
...
const string strMessageMagic = "ANS Signed Message:\n";
