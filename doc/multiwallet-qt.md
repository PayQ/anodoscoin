...
In order to support loading of multiple wallets in ans-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ans.cpp.
...
Changes to ans.cpp
----------------------
ans.cpp is the entry point into ans-qt, and as such, will require some minor modifications to provide hooks for
